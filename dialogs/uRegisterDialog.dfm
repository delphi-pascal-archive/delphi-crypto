object RegisterContent: TRegisterContent
  Left = 0
  Top = 0
  Width = 400
  Height = 401
    ...
    object tbMain: TsTabSheet
      ...
      object pnlMainLabels: TsPanel
        ...
        object lbPassword2: TsLabel
          ...
          Alignment = taRightJustify
          AutoSize = False
          Caption = #1077#1097#1077' '#1088#1072#1079
          Color = 2169368
          ParentColor = False
          ParentFont = False
          Font.Charset = RUSSIAN_CHARSET
        ...
        object lbMailPassword: TsLabel
          ...
          Alignment = taRightJustify
          AutoSize = False
          Caption = #1087#1072#1088#1086#1083#1100' '#13#10#1101#1083'. '#1087#1086#1095#1090#1099
        end
      end
      object pnlMainControls: TsPanel
        ...
        object MailPassword: TsMaskEdit
          AlignWithMargins = True
          Left = 9
          Top = 137
          Width = 263
    ...
    object tbCrypto: TsTabSheet
      ...
      object pnlCryptoLabels: TsPanel
        ...
        object lbPrivateKey: TsLabel
          ...
          Alignment = taRightJustify
          AutoSize = False
          Caption = #1087#1088#1080#1074'. '#1082#1083#1102#1095
          ParentFont = False
          Font.Charset = RUSSIAN_CHARSET
          Font.Color = clRed
          Font.Height = -13
