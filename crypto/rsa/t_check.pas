{Main test program for MPArith/mp_int,  (c) W.Ehrhardt 2004-2011}
...
begin
  f := 0;
  cnt := 0;
  write('mp_(read)_radix_astr test: ');
...
begin
  writeln('Test of MPArith V', MP_VERSION, ' [main test]  (c) 2004-2011 W.Ehrhardt ');
